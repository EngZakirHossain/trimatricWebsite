...
(function (c) {
    jQuery.fn.lavaLamp = function (a) {
        ...
        return this.each(function () {
            ...
            var w = location.pathname + location.search + location.hash, l = c(a.target, this).not("." + a.skipClass),
                g, n = 0, p = 0, t = 0, u = 0, h = 0, k = 0;
            ...
            c(this).on("mouseleave focusout", function () {
                var b = null;
                if (a.returnHome) b = q; else if (!a.autoReturn) return !0;
